...
public class streamApiTest {
    ...
    public void testTask1() {
        ...
        List<Employee> result = streamApi.task1(employees);
    ...
    public void testTask2() {
        ...
        List<String> result = streamApi.task2(employees);
        assertNotNull(result);
        assertEquals(2, result.size());
    ...
    public void testTask3() {
        ...
        double result = streamApi.task3(employees);
    ...
    public void testTask4() {
        ...
        List<Employee> result = streamApi.task4(Arrays.asList(employeeDepartment1, employeeDepartment2));
        System.out.println(result);
        assertNotNull(result);
    ...
    public void testTask5() {
        ...
        List<Employee> result = streamApi.task5(employees,1, 3);
        assertNotNull(result);
        ...
        List<Employee> result2 = streamApi.task5(employees,2, 3);
    ...
    public void testTask6() {
        ...
        String result = streamApi.task6(employees);
        assertNotNull(result);
    ...
    public void testTask7() {
        ...
        boolean result = streamApi.task7(employees);
        assertTrue(result);
        System.out.println(result);
    }
    ...
    public void testTask8() {
        ...
        Map<PositionType, Double> result = streamApi.task8(employees);
        assertNotNull(result);
        assertEquals(3, result.size());
    ...
    public void testTask9() {
        ...
        Map<Boolean, Long> result = streamApi.task9(employees);
        assertNotNull(result);
        assertEquals(2, result.size());
    ...
    public void testTask10() {
        ...
        Map<Boolean, String> result = streamApi.task10(employees);
        assertNotNull(result);
        assertEquals(2, result.size());

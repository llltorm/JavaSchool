...
import ru.lesson.dto.Employee;
import ru.lesson.dto.PositionType;
...
public class StreamApi {
    ...
    public boolean task7(List<Employee> employees) {
        ...
        return employees.stream().
                map(Employee::getName).
                anyMatch(employee -> !employees.contains(employee));
    }
    ...
    public Map<PositionType, Double> task8(List<Employee> employees) {
        return employees.stream().
                collect(Collectors.groupingBy(Employee::getPositionType, averagingDouble(Employee::getRating)));
    }
    ...
    public Map<Boolean, Long> task9(List<Employee> employees) {
        return employees.stream().
                collect(Collectors.partitioningBy(employee -> employee.getRating() > 50 ? true : false, counting()));
    }
    ...
    public Map<Boolean, String> task10(List<Employee> employees) {
        return employees.stream().
                collect(Collectors.partitioningBy(employee -> employee.getRating() > 50 ? true : false,
